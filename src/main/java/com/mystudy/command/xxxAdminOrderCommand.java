...
public class xxxAdminOrderCommand implements AdminCommand{
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		p.setTotalRecord(AdminOrderDAO.totalCountOrder());
		p.setTotalPage();
		...
		List<AdminOrderVO> list = AdminOrderDAO.orderList(p.getBegin(), p.getEnd());
