...
public class xxxAdminOrderSearchCommand implements AdminCommand{
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		p.setTotalRecord(AdminOrderDAO.SearchCountorderList(select, keyword));
		p.setTotalPage();
		...
		if (keyword == null || keyword.equals("")) {
			...
			List<AdminOrderVO> nowpageList = AdminOrderDAO.searchOrder(select, keyword, Integer.toString(p.getBegin()), Integer.toString(p.getEnd()));
			System.out.println(">> 현재페이지 주문목록 : " + nowpageList);
			System.out.println(">> 현재페이지 주문수 : " + nowpageList.size());			
