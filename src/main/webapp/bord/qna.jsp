...
<%
	...
	p.setTotalPage();
	System.out.println(">전체 게시글 수 확인 : " + p.getTotalRecord());
	System.out.println(">전체 페이지 수 확인 : " + p.getTotalPage());
			...
			<tr>
				<td colspan="4"  style="border-bottom: none;">
					<ol class="paging">
						...
						<c:if test="${pvo.beginPage != 1 }">
								<li><a href="/Project_shop/bord/qna.jsp?cPage=${pvo.beginPage -1 }&id=${id}">이전으로</a></li>
						</c:if>
						...
						<c:if test="${pvo.endPage < pvo.totalPage }">
								<li><a href="/Project_shop/bord/qna.jsp?cPage=${pvo.endPage +1}&id=${id}">다음으로</a></li>
							</c:if>
				...
				<td style="border-bottom: none;">
					...
					<!-- <input type="button" value="글쓰기" class="btn btn-default"  onclick="write()"> -->
				</td>
			</tr>
			<tr>
